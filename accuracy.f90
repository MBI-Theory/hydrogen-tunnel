...
!*nq integer, parameter :: rk     = selected_real_kind(14,17)  ! "Normal" reals and complex (complexi? :-)
!*qd integer, parameter :: rk     = selected_real_kind(28,50)  ! quad-precision
  !
  ...
  !
  character(len=clen), save :: rcsid_accuracy = "$Id: accuracy.f90,v 1.45 2021/04/26 15:44:44 ps Exp $"
  !
